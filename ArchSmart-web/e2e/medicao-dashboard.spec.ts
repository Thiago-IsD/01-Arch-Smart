...
/**
 * Mede "do clique até os dados na tela" no Dashboard.
 *
 * Cópia adaptada de `medicao-biblioteca.spec.ts` (Tarefa 7 da migração do
 * Dashboard, Seção 8). Não é teste de regressão: é instrumento. Roda com
...
test("mede o tempo até o painel do Dashboard ter dados", async ({ page }) => {
    ...
    if (!email || !password) {
        throw new Error(
            ...
            "E2E_EMAIL=... E2E_PASSWORD=... npx playwright test e2e/medicao-dashboard.spec.ts"
        )
    }
