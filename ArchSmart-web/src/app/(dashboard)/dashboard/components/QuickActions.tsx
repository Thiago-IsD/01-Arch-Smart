                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    >
                        <div className="flex items-center gap-3">
                            <div className="p-2 bg-primary/10 rounded-lg text-primary group-hover:scale-110 group-focus-within:scale-110 transition-transform">
                                <Plus className="h-5 w-5" />
                            </div>
                            <span className="font-semibold text-foreground">Criar Projeto</span>
                        </div>
                        <ChevronRight className="h-4 w-4 text-muted-foreground group-hover:translate-x-1 group-focus-within:translate-x-1 transition-transform" />
                    </Button>
                    ...
                    >
                        <div className="flex items-center gap-3">
                            <div className="p-2 bg-secondary/10 rounded-lg text-secondary group-hover:scale-110 group-focus-within:scale-110 transition-transform">
                    ...
                    <Button
                        variant="outline"
                        className="h-16 justify-between text-base border-border hover:border-muted-foreground/40 hover:bg-muted shadow-sm transition-all group"
                        onClick={() => router.push("/finance")}
                    >
                        <div className="flex items-center gap-3">
                            <div className="p-2 bg-muted rounded-lg text-foreground group-hover:scale-110 group-focus-within:scale-110 transition-transform">
