    ...
    <section className={cn('w-full overflow-hidden bg-background py-12 sm:py-24', className)}>
      <div className="container mx-auto grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-8">
        ...
        >
          ...
          />
          <motion.div
            className="absolute bottom-0 right-1/4 h-12 w-12 rounded-lg bg-secondary/20"
            variants={floatingVariants}
            animate="animate"
            style={{ transitionDelay: '0.5s' }}
          />
          <motion.div
            className="absolute bottom-1/4 left-4 h-6 w-6 rounded-full bg-accent/20"
            variants={floatingVariants}
            animate="animate"
          ...
          >
            <div className="relative h-full w-full overflow-hidden rounded-xl">
              <img src={images[0]} alt="Hero 1" className="object-cover w-full h-full" />
            </div>
          </motion.div>
          <motion.div
          ...
          >
            <div className="relative h-full w-full overflow-hidden rounded-xl">
              <img src={images[1]} alt="Hero 2" className="object-cover w-full h-full" />
            </div>
          </motion.div>
          <motion.div
          ...
          >
            <div className="relative h-full w-full overflow-hidden rounded-xl">
              <img src={images[2]} alt="Hero 3" className="object-cover w-full h-full" />
            </div>
          </motion.div>
        </motion.div>
      </div>
